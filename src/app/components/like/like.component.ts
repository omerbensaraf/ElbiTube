...
export class LikeComponent implements OnInit {
  ...
  constructor(private mediaService : MediaService) { 
    ...
    this.likeCounter = this.specificItem.likeCounter;
    this.unLikeCounter = this.specificItem.unLikeCounter;
  ...
  updateItem(updates : Updates){
    this.specificItem.likeCounter = this.likeCounter;
    this.specificItem.unLikeCounter = this.unLikeCounter;
    switch(updates){
