...
@Component({
  selector: 'app-displayed-video-properties',
  templateUrl: './displayed-video-properties.component.html',
  styleUrls: ['./displayed-video-properties.component.scss',
...
export class DisplayedVideoPropertiesComponent implements OnInit {
